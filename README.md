...
- Macro & meal logging with editable daily meal view
- Meal presets (save + reuse meals instantly)
- Automated suggestions based on rolling 7–30 day averages
- Strength tracking using estimated 1RM curves
